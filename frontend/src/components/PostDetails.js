  ...
  return (
    <div>
      ...
      <motion.div
        ...
        id={`post_${post._id}`}
        className={`post static flex flex-col justify-center p-5 my-3 bg-black shadow-[0px_0px_10px_0px_#1e1b4b] rounded-xl bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-70 border border-gray-700 text-white w-full self-center  ${
          isExpanded ? 'hidden' : ''
        }`}>
